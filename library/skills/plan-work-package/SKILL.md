...
description: Turn an approved repository plan into one closed qa-toolkit work-package task; use only when the user explicitly asks to prepare structured work.
---
