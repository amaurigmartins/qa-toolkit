...
description: Implement and finish one staged qa-toolkit work item within its allowed paths; use when the user explicitly asks to execute that exact task.
---
